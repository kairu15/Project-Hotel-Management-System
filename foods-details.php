    ...
    <div class="container">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;">
            ...
            <div style="position: relative; border-radius: 15px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
                <img src="https://images.unsplash.com/photo-<?php echo ['1504674900247-0877df9cc836','1540189549336-e6e99c3679fe','1565299624946-b28f40a0ae38','1567620905732-2d1ec7ab7445'][$item['item_id'] % 4] ?>?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
            ...
            <div style="background-color: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 20px rgba(0,0,0,0.08); transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                <div style="height: 200px; overflow: hidden;">
                    <img src="https://images.unsplash.com/photo-<?php echo ['1504674900247-0877df9cc836','1540189549336-e6e99c3679fe','1565299624946-b28f40a0ae38','1567620905732-2d1ec7ab7445'][$related['item_id'] % 4] ?>?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" 
