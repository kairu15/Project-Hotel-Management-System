<?php
/**
 * Admin Notification Settings Page - Bayawan Bai Hotel
 * Manage notification preferences for admin
 */
...
$notificationTypes = [
    ...
    'schedule' => [
        ...
        'description' => 'Updates to staff schedules and shift assignments',
        'icon' => 'clock',
        'color' => '#ffc107'
    ],
    'maintenance' => [
    ...
    'event' => [
        ...
        'description' => 'New event space booking requests',
        'icon' => 'calendar-alt',
        'color' => '#e83e8c'
    ],
    'promotion' => [
        'label' => 'Promotions & Marketing',
        'description' => 'Promotional campaign updates and marketing activities',
        'icon' => 'tag',
        'color' => '#20c997'
    ],
    'system' => [
        'label' => 'System Alerts',
        'description' => 'System updates, security alerts, and critical notifications',
        'icon' => 'cog',
        'color' => '#6c757d'
    ]
];
