<?php
/**
 * User Notification Settings Page - Bayawan Bai Hotel
...
$notificationTypes = [
    'booking' => [
        ...
        'description' => 'Notifications about your room bookings, check-ins, check-outs, and cancellations',
        'icon' => 'calendar-check',
        'color' => '#28a745'
    ],
    'food_order' => [
        'label' => 'Food Orders',
        'description' => 'Updates about your food orders, preparation status, and delivery',
        'icon' => 'utensils',
        'color' => '#fd7e14'
    ],
    'payment' => [
    ...
    'event' => [
        ...
        'description' => 'Notifications about your event space bookings',
        'icon' => 'calendar-alt',
        'color' => '#e83e8c'
    ],
    'promotion' => [
