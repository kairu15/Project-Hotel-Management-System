<?php
/**
 * Check-In - Bayawan Bai Hotel
 * Shows guests who are currently checked in
 */
...
// Get checked-in reservations only
$allReservations = [];
...
// Events don't typically have checked_in status, but include for consistency
...
<div class="inbox-container">
    <div class="inbox-header">
        <h2><i class="fas fa-door-open"></i> Currently Checked In</h2>
    </div>
    ...
    <div class="inbox-filters">
        ...
        <a href="checkin.php" class="filter-btn active"><i class="fas fa-door-open"></i> Check-In <span class="count"><?php echo $statusCounts['checked_in']; ?></span></a>
    ...
    <div class="inbox-list">
        <?php foreach ($allReservations as $reservation): 
            ...
            $today = new DateTime();
            $nightsRemaining = $today->diff($checkOut)->days;
        ?>
            ...
            <div class="item-content">
                ...
                <div class="item-meta">
                    ...
                    <span class="stay-info">
                        ...
                        <?php echo $nightsRemaining; ?> night(s) remaining
                    </span>
                </div>
            </div>
    ...
    <div class="empty-state">
        ...
        <a href="confirmed.php" class="btn btn-primary">
