<?php
/**
 * User Notifications Page - Bayawan Bai Hotel
 * Full notification listing with filtering and management
 */
...
<div class="notifications-container">
    <div class="notifications-header">
        <h2><i class="fas fa-bell" style="margin-right: 10px; color: var(--primary-color);"></i>My Notifications</h2>
