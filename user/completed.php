    ...
    <div class="inbox-list">
        ...
        <div class="inbox-item">
            ...
            <div class="item-actions">
                ...
                <form method="POST" style="display: inline;" onsubmit="return confirm('Archive this event?');">
                ...
                <form method="POST" style="display: inline;" onsubmit="return confirm('Move this event to trash?');">
